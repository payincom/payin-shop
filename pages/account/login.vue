        ...
        if (this.$v.$invalid) {
          ...
          try {
            ...
            if (result.data.errcode) {
              ...
              this.$toast.show('Login success! Loading...')
            }
        ...
        <div class="card-body p-4">
          ...
          <form action="#" @submit.prevent="tryToLogIn">
            ...
            <div class="form-group mb-3">
              ...
              <input class="form-control" v-model="email" type="email" id="emailaddress" placeholder="Enter your email"
            ...
            <div class="form-group mb-0 text-center" v-if="!tryingToLogIn">
              <button class="btn btn-primary btn-block" type="submit"> Log In</button>
            </div>

          </form>
          <br>
          <div class="text-center" v-if="tryingToLogIn">
