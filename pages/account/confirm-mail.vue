...
.st3 {
  ...
  stroke-miterlimit: 10;
            ...
            <p class="text-muted mt-2">
              ...
              <span class="font-weight-medium">you</span>.
              Please check for an email from Payin and receive your password.
            </p>

            <nuxt-link to="/" class="btn btn-block btn-primary waves-effect waves-light mt-3">Login</nuxt-link>
          </div>
        </div>
        <!-- end card-body -->
      </div>
